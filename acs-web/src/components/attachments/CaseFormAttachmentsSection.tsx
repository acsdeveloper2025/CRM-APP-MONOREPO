      ...
      <CardContent className="space-y-4">
        ...
        <div
          className={cn(
            ...
            attachments.length >= maxFiles ? "opacity-50 pointer-events-none" : "hover:border-gray-400"
          )}
          onDrop={handleDrop}
        ...
        >
          ...
          <p className="text-xs text-gray-500">
            PDF and image files only. Max {Math.round(maxFileSize / 1024 / 1024)}MB per file, {maxFiles} files total.
          </p>
          <input
            ref={fileInputRef}
            type="file"
